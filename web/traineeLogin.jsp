...
<%! private static final Logger LOGGER = Logger.getLogger("traineeLogin.jsp"); %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Trainee Login - BHEL HRDC</title>
...
<body>
    ...
    <div class="login-container">
        <div class="login-card">
            <h2>Trainee Login</h2>
            <form action="traineeLogin.jsp" method="post" accept-charset="UTF-8" onsubmit="toggleLoading(this.querySelector('.btn'))" aria-label="Trainee Login Form">
                ...
                if ("POST".equalsIgnoreCase(request.getMethod())) {
                    ...
                    if (email != null && !email.trim().isEmpty() && 
                        ...
                        try {
                            ...
                            String sql = "SELECT username, password, role FROM users WHERE email = ? AND role = 'Trainee'";
            ...
            <%
                                ...
                                LOGGER.warning("Login failed: Invalid email or not a Trainee for email=" + email);
            %>
            <div class="alert alert-error" role="alert">
                <p>Invalid email or not a Trainee.</p>
            </div>
            <%
                            }
